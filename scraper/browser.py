...
def new_chrome_driver(worker_id=None):
    ...
    opts.add_argument(f"--user-data-dir={os.path.join(base, f'profile_{stamp}')}")
    ...
    if CHROMEDRIVER_PATH and os.path.isfile(CHROMEDRIVER_PATH):
        ...
        svc = Service(executable_path=ChromeDriverManager().install(), log_path=os.devnull)

    # Suprimir salida de ChromeDriver y librerías ruidosas
